...
@Name("oembedResourceManager")
@Scope(ScopeType.EVENT)
public class oembedResourceManagerBean implements Serializable {

    private static final long serialVersionUID = 1L;

    private static final Log log = LogFactory.getLog(oembedResourceManagerBean.class);
